...
I can remove video & image backgrounds send me a photo to try out"""
HELP_TEXT = """**More Help**
...
BUTTONS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton('Join Updates Channel', url='https://telegram.me/https://t.me/infinitybotzz')
        ]
    ]
)
